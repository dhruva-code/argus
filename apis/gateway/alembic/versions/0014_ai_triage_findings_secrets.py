...
def upgrade() -> None:
    op.add_column("findings", sa.Column("ai_classification", sa.String(120), nullable=False, server_default=""))
    op.add_column(
        "findings", sa.Column("ai_false_positive_likelihood", sa.String(20), nullable=False, server_default="")
    )
    op.add_column("findings", sa.Column("ai_reasoning", sa.Text(), nullable=False, server_default=""))
    op.add_column("findings", sa.Column("ai_engine", sa.String(20), nullable=False, server_default=""))
    op.add_column("findings", sa.Column("ai_analyzed_at", sa.DateTime(timezone=True), nullable=True))
    op.add_column("findings", sa.Column("ai_fingerprint", sa.String(64), nullable=False, server_default=""))

    op.add_column("secrets", sa.Column("ai_classification", sa.String(20), nullable=False, server_default=""))
    op.add_column("secrets", sa.Column("ai_reasoning", sa.Text(), nullable=False, server_default=""))
    op.add_column("secrets", sa.Column("ai_engine", sa.String(20), nullable=False, server_default=""))
    op.add_column("secrets", sa.Column("ai_analyzed_at", sa.DateTime(timezone=True), nullable=True))
    op.add_column("secrets", sa.Column("ai_fingerprint", sa.String(64), nullable=False, server_default=""))
